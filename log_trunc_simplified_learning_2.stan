//==============================================================================
// Model Overview: Learning with Asymmetric Persistence (Kappa Removed)
//
// This version maintains:
// 1. Two Deltas: delta_B (params[6]) and delta_R (params[7]) for asymmetric 
//    memory of feedback.
// 
// Removed:
// 2. Kappa Boost: The confirmation bias scaling has been stripped out.
//==============================================================================
...
functions {
  ...
  real partial_sum(array[] int slice_indices,
    ...
    for (i in 1:size(slice_indices)) {
      ...
      // Parameter space is now 7: alpha, beta, lambda, theta, psi, delta_B, delta_R
      vector[7] params;
      ...
      for (t in 1:Tsubj[n]) {
        ...
        for (s in 1:sample_size) {
          ...
          // Kappa logic removed: direct evidence accumulation REVIEW 
