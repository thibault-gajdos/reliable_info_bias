...
# The grid values are taken directly from the Implicit Aware posterior summary:
#
#   alpha  = 2.602 [1.628, 3.697]
#   beta   = 0.352 [0.185, 0.518]
#   lambda = 0.0512 [0.0239, 0.0808]
#   delta  = 0.937 [0.703, 1.171]
#   eta    = -0.477 [-0.744, -0.227]
#
...
load(file = './data/data_priorbelief_aware_exp11.rdata')
...
alpha_range  <- c(1.628, 2.602, 3.697)
beta_range   <- c(0.185, 0.352, 0.518)
lambda_range <- c(0.0239, 0.0512, 0.0808)
delta_range  <- c(0.703, 0.937, 1.171)
eta_range    <- c(-0.744, -0.477, -0.227)
...
dir.create('./results/choice_learning', recursive = TRUE, showWarnings = FALSE)

out_file <- sprintf('./results/choice_learning/recover_%d.rds', k)
