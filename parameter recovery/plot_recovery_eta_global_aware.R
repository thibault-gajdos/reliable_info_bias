...
# ============================================================================
# Plot Parameter Recovery — Global Eta Learning Model: Exp11 Aware
# ============================================================================
#
# This script is for the Apocrita parameter-recovery output:
#
#   results/choice_eta_global_aware_exp11/recover_1.rds
#   results/choice_eta_global_aware_exp11/recover_2.rds
#   ...
#   results/choice_eta_global_aware_exp11/recover_243.rds
#
...
# Command:
#   module load R
#   Rscript plot_recovery_choice_eta_global_aware.R
#
# ============================================================================
...
plot_dir    <- file.path(project_dir, "figures", "choice_eta_global_aware_exp11")
...
expected_variant <- "global_eta_aware_exp11"
result_variants <- vapply(
  res_list,
  function(x) {
    if (is.null(x$model_variant)) NA_character_ else as.character(x$model_variant)
  },
  character(1)
)

wrong_variant <- !is.na(result_variants) & result_variants != expected_variant

if (any(wrong_variant)) {
  stop(
    "The results folder contains files from another model variant: ",
    paste(unique(result_variants[wrong_variant]), collapse = ", ")
  )
}
...
param_info <- list(
  ...
  eta    = list(sim = "Simulated global eta", fit = "Fitted global eta")
)
...
write.csv(df_group, file.path(plot_dir, "group_recovery_all_runs_global_eta_aware_exp11.csv"), row.names = FALSE)
write.csv(df_indiv, file.path(plot_dir, "individual_recovery_all_runs_global_eta_aware_exp11.csv"), row.names = FALSE)
write.csv(df_diag,  file.path(plot_dir, "diagnostics_all_runs_global_eta_aware_exp11.csv"), row.names = FALSE)
...
write.csv(group_stats, file.path(plot_dir, "group_recovery_summary_global_eta_aware_exp11.csv"), row.names = FALSE)
write.csv(indiv_stats, file.path(plot_dir, "individual_recovery_summary_global_eta_aware_exp11.csv"), row.names = FALSE)
...
save_plot_grid(
  panels = panels_group,
  filename_base = "recovery_group_global_eta_aware_exp11",
  width = 12,
  height = 7
)
...
save_plot_grid(
  panels = panels_indiv,
  filename_base = "recovery_individual_global_eta_aware_exp11",
  width = 12,
  height = 7
)
...
ggsave(file.path(plot_dir, "recovery_group_bias_global_eta_aware_exp11.pdf"), p_group_bias, width = 8, height = 5)
ggsave(file.path(plot_dir, "recovery_group_bias_global_eta_aware_exp11.png"), p_group_bias, width = 8, height = 5, dpi = 300)
...
ggsave(file.path(plot_dir, "recovery_individual_bias_global_eta_aware_exp11.pdf"), p_indiv_bias, width = 8, height = 5)
ggsave(file.path(plot_dir, "recovery_individual_bias_global_eta_aware_exp11.png"), p_indiv_bias, width = 8, height = 5, dpi = 300)
...
ggsave(file.path(plot_dir, "diagnostics_max_rhat_global_eta_aware_exp11.pdf"), p_rhat, width = 7, height = 4)
ggsave(file.path(plot_dir, "diagnostics_max_rhat_global_eta_aware_exp11.png"), p_rhat, width = 7, height = 4, dpi = 300)
...
ggsave(file.path(plot_dir, "diagnostics_min_ess_global_eta_aware_exp11.pdf"), p_ess, width = 7, height = 4)
ggsave(file.path(plot_dir, "diagnostics_min_ess_global_eta_aware_exp11.png"), p_ess, width = 7, height = 4, dpi = 300)
...
ggsave(file.path(plot_dir, "diagnostics_divergences_global_eta_aware_exp11.pdf"), p_div, width = 7, height = 4)
ggsave(file.path(plot_dir, "diagnostics_divergences_global_eta_aware_exp11.png"), p_div, width = 7, height = 4, dpi = 300)
...
ggsave(file.path(plot_dir, "param_correlations_global_eta_aware_exp11.pdf"), p_corr, width = 7, height = 6)
ggsave(file.path(plot_dir, "param_correlations_global_eta_aware_exp11.png"), p_corr, width = 7, height = 6, dpi = 300)
