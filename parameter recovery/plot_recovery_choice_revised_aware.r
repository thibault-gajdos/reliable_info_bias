...
# ============================================================================
# Plot Parameter Recovery — Learning Choice Model
# ============================================================================
#
# This script is for the Apocrita parameter-recovery output:
#
#   results/choice_learning/recover_1.rds
#   results/choice_learning/recover_2.rds
#   ...
#   results/choice_learning/recover_243.rds
#
...
# Command:
#   module load R
#   Rscript plot_recovery_choice_learning_grid.R
#
# ============================================================================
...
results_dir <- file.path(project_dir, "results", "choice_learning")
plot_dir    <- file.path(project_dir, "figures", "choice_learning")
...
write.csv(df_group, file.path(plot_dir, "group_recovery_all_runs.csv"), row.names = FALSE)
write.csv(df_indiv, file.path(plot_dir, "individual_recovery_all_runs.csv"), row.names = FALSE)
write.csv(df_diag,  file.path(plot_dir, "diagnostics_all_runs.csv"), row.names = FALSE)
...
write.csv(group_stats, file.path(plot_dir, "group_recovery_summary.csv"), row.names = FALSE)
write.csv(indiv_stats, file.path(plot_dir, "individual_recovery_summary.csv"), row.names = FALSE)
...
save_plot_grid(
  panels = panels_group,
  filename_base = "recovery_group_learning",
  width = 12,
  height = 7
)
...
save_plot_grid(
  panels = panels_indiv,
  filename_base = "recovery_individual_learning",
  width = 12,
  height = 7
)
...
ggsave(file.path(plot_dir, "recovery_group_bias_learning.pdf"), p_group_bias, width = 8, height = 5)
ggsave(file.path(plot_dir, "recovery_group_bias_learning.png"), p_group_bias, width = 8, height = 5, dpi = 300)
...
ggsave(file.path(plot_dir, "recovery_individual_bias_learning.pdf"), p_indiv_bias, width = 8, height = 5)
ggsave(file.path(plot_dir, "recovery_individual_bias_learning.png"), p_indiv_bias, width = 8, height = 5, dpi = 300)
...
ggsave(file.path(plot_dir, "diagnostics_max_rhat_learning.pdf"), p_rhat, width = 7, height = 4)
ggsave(file.path(plot_dir, "diagnostics_max_rhat_learning.png"), p_rhat, width = 7, height = 4, dpi = 300)
...
ggsave(file.path(plot_dir, "diagnostics_min_ess_learning.pdf"), p_ess, width = 7, height = 4)
ggsave(file.path(plot_dir, "diagnostics_min_ess_learning.png"), p_ess, width = 7, height = 4, dpi = 300)
...
ggsave(file.path(plot_dir, "diagnostics_divergences_learning.pdf"), p_div, width = 7, height = 4)
ggsave(file.path(plot_dir, "diagnostics_divergences_learning.png"), p_div, width = 7, height = 4, dpi = 300)
...
ggsave(file.path(plot_dir, "param_correlations_learning.pdf"), p_corr, width = 7, height = 6)
ggsave(file.path(plot_dir, "param_correlations_learning.png"), p_corr, width = 7, height = 6, dpi = 300)
